...
def generate_subtitles(video_path):
    ...
    try:
        ...
        os.system(f"/home/develop/anaconda3/envs/minigpt4/bin/whisper {audio_path}  --language Chinese --model large --task translate --output_format vtt --output_dir workspace/inference_subtitles")
        # os.system(f"/home/develop/anaconda3/envs/minigpt4/bin/whisper {audio_path}  --language English --model large --output_format vtt --output_dir workspace/inference_subtitles")
...
if __name__ == "__main__":
    ...
    # os.system(f"whisper '/home/develop/fyy/MiniGPT4-video-main/workspace/inference_subtitles/mp3/0.mp3'  --language English --model large --output_format vtt --output_dir workspace/inference_subtitles")
